function Level1() {
    ...
    function create() {
        ...
        portalAusgang = this.physics.add.sprite(1100, 175, 'portalAusgang'); //POSTITION VON DER ER RUNTER FÄLLT
        this.anims.create({
            key: 'startAusgang',
        ...
        //        this.physics.add.collider(player, portal, nextLevel, null, this);
